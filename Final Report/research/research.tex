...
For this project, the modified version of the DDSP archtecture based off \citetitle{SingingDDSP}\cite{SingingDDSP} was used. The architecture differs from the original in that there are additional MLP layers.
