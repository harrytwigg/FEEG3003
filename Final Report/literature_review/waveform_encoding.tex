...
\framebox[1.1\width]{
    \begin{minipage}{0.8\textwidth}
        Deep Neural Networks (DNNs) are a neural network with multiple hidden layers between the input and output layers. They are well suited for learning complex functions humans or other arterficial neural networks can't intuitively see from large datasets.
    \end{minipage}
}
\vspace{0.5cm}
